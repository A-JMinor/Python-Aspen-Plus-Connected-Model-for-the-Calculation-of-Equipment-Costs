...
The equations for the cost calculation of a kettle reboiler or condenser are given at the subfolder [Heat Exchangers](https://github.com/A-JMinor/Python-Aspen-Plus-Connected-Model-for-the-Calculation-of-Equipment-Costs/tree/main/0Heat-Exchanger).
